...
{
    protected Bitmap image;                      // the rasterized image
    ...
    /**
     * Returns the Bitmap defined in this MyroImage.
     */
...
//    }
     ...
     */
    public abstract MyroColor getColor(int x, int y );
     ...
     */
    public abstract void setColor( int x, int y, MyroColor color);
...
//    }
     ...
     */
    protected double lum(MyroColor color) {
        int  r = color.getRed();
     ...
     */
    protected MyroColor toGray(MyroColor color) {
        int y = (int) (Math.round( lum( color ) ) );   // round to nearest int
        return new MyroColor(y,y,y);
    }
    ...
    private class MyroYUVColor
    {
        ...
        public MyroYUVColor( MyroColor c )
        {
            set2rgb( c );
        }

        public MyroColor yuv2rgb()
        {
        ...
        public void set2rgb( MyroColor c )
        {
            int r = c.getRed();
            int g = c.getGreen();
            int b = c.getBlue();
    ...
    void resize(int width, int height){
        Bitmap newBitmap = Bitmap.createScaledBitmap(image, 128,
                192, false);
